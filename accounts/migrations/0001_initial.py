# Generated by Django 3.1.2 on 2021-02-25 21:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_name', models.CharField(max_length=25, null=True, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Item Name')),
                ('item_description', models.CharField(max_length=256, null=True, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='First Name')),
                ...
                ('last_update', models.DateTimeField(default=datetime.datetime.utcnow, verbose_name='DateTime of Last Update to Item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_number', models.CharField(default='N/A', max_length=20, verbose_name='License')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='auditapplication_sponsor', to='accounts.userinformation')),
                ('sponsor_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.sponsorcompany')),
            ],
        ),
    ]
